        ...
        <section className="resume-section p-3 p-lg-5 d-flex d-column" id="about">
          <div className="my-auto">
            ...
            <div className='text-justify'>
              ...
              <p className="lead mb-4">My professional interests include product strategy and operations, business analysis, service design, experimenting and implementing digital solutions that enhance product experience. I am a great fit for any role that sits at the intersection of business savvy and technology.</p>
